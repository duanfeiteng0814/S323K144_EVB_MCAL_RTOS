...
#define DIO_SW_PATCH_VERSION_CFG            3
...
/**
* @brief          Symbolic name for the channel DioChannel_RGB_RED.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_RGB_RED ((uint16)0x0024U)

/**
* @brief          Symbolic name for the channel DioChannel_RGB_GREEN.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_RGB_GREEN ((uint16)0x0025U)
...
/**
* @brief          Symbolic name for the channel DioChannel_RGB_BLUE.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_RGB_BLUE ((uint16)0x0088U)
