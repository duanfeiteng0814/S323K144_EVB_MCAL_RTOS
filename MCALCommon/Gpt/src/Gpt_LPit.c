...
#define GPT_LPIT_SW_PATCH_VERSION_C             3
...
FUNC(Std_ReturnType, GPT_CODE) Gpt_LPit_EnableChainMode(VAR(uint8, AUTOMATIC) u8HwChannel)
{
    ...
    {
        /* Enable Chain Mode*/
        /** @violates @ref GPT_PIT_C_REF_2 MISRA 2012  Required Rule 11.6, This macro computes the address
        *   of any register by using the hardware offset of the controller.*/
        /** @violates @ref GPT_PIT_C_REF_5 MISRA 2012 Advisory Rule 11.4, The cast is used to access
        *   memory mapped registers.*/
        /** @violates @ref GPT_PIT_C_REF_3 MISRA 2004 Rule 11.1, Cast from unsigned long to pointer*/
        /** @violates @ref GPT_PIT_C_REF_6 Violates MISRA 2004 Rule 11.3, Cast from pointer type and integral type.*/         
        REG_BIT_SET32(LPIT_TCTRL_ADDR32(u8ModuleIdx,u8ChannelIdx), (uint32)GPT_LPIT_TCTRL_CHAIN_MASK_U32);
