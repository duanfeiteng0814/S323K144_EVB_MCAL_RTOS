...
#define PWM_FTM_SW_PATCH_VERSION                  3
/**@}*/
...
#endif /* (PWM_ENABLE_TRIGEER_API == STD_ON) */
...
#endif /* (PWM_DISABLE_TRIGEER_API == STD_ON) */
...
#endif /* ((PWM_DISABLE_TRIGEER_API == STD_ON) || (PWM_ENABLE_TRIGEER_API == STD_ON)) */
