...
#define LIN_SW_PATCH_VERSION_NONASR_C               3
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
...
#if ((LIN_SW_MAJOR_VERSION_NONASR_C != LIN_SW_MAJOR_VERSION_IPW) || \
     (LIN_SW_MINOR_VERSION_NONASR_C != LIN_SW_MINOR_VERSION_IPW) || \
     (LIN_SW_PATCH_VERSION_NONASR_C != LIN_SW_PATCH_VERSION_IPW) \
    )
    #error "Software Version Numbers of Lin_NonASR.c and Lin_Ipw.h are different"
#endif
